...
export const VideoCard: React.FC<VideoCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="relative mx-auto h-full w-full max-h-[calc(100dvh-var(--bottom-nav-height,0))] sm:max-h-[calc(100dvh-var(--bottom-nav-height,0))] overflow-hidden rounded-2xl bg-card text-white shadow-card"
