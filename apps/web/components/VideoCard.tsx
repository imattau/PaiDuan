...
export const VideoCard: React.FC<VideoCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="relative mx-auto w-full max-w-full max-h-[calc(100dvh-var(--bottom-nav-height,0))] sm:max-h-[calc(100vh-var(--bottom-nav-height,0))] aspect-[9/16] overflow-hidden rounded-2xl bg-card text-white shadow-card min-[aspect-ratio:16/9]:h-[calc(100dvh-var(--bottom-nav-height,0))] min-[aspect-ratio:16/9]:w-auto"
