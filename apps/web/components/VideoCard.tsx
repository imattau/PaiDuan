...
export const VideoCard: React.FC<VideoCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="relative mx-auto h-screen w-full flex-1 min-h-0 overflow-hidden rounded-2xl bg-card text-white shadow-card [height:calc(100dvh-var(--bottom-nav-height,0))]"
