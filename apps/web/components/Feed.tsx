...
export const Feed: React.FC<FeedProps> = ({ items, loading, loadMore }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-[calc(100dvh-var(--bottom-nav-height,0))] sm:min-h-[calc(100dvh-var(--bottom-nav-height,0))] w-full">
        <SkeletonVideoCard />
      </div>
    );
  }
  ...
  if (items.length === 0) {
    return (
      <div className="flex min-h-[calc(100dvh-var(--bottom-nav-height,0))] sm:min-h-[calc(100dvh-var(--bottom-nav-height,0))] w-full flex-col items-center justify-center text-white">
        <EmptyState />
  ...
  return (
    <>
      <Virtuoso
        ...
        className="min-h-[calc(100dvh-var(--bottom-nav-height,0))] sm:min-h-[calc(100dvh-var(--bottom-nav-height,0))] w-full overflow-auto snap-y snap-mandatory scrollbar-none"
        endReached={loadMore}
